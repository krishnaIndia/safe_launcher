...
router.get('/appendable-data/deleted-data/:handleId/:index', new ActivityMiddleware('Get DataId from appendable data - deleted'),
  AppendableData.getDeletedDataIdAt);
