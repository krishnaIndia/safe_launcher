...
var AppList = React.createClass({
  ...
  render: function() {
    ...
    for (var i in this.props.list) {      
      ...
      listItem = React.DOM.div({ key: i, className: 'app-li-i', 'data-id': this.props.list[i].id,
        ...
        React.DOM.h4({ key: 'sub-title-' + i, className: 'sub-title' },
        'Last Active: ' + (this.props.list[i].lastActive || '')),
        statusBar,
        option
      ]);
